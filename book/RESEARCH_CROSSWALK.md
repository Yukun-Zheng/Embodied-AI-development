...
| **28 Robot Memory** | [Runnable Lab 27](../labs/runnable/lab27_long_horizon_memory/README.md) | [Lab 27 CI Reference](../labs/runnable/lab27_long_horizon_memory/REFERENCE_RESULTS.md)、Model Atlas | bounded recent context、persistent episodic trace 与 compact semantic state 是否被分开？cue 离开 context 后谁还能成功？capacity-matched shuffled memory 与 unrelated memory 是否证明收益来自正确 task state？storage / retrieval cost 是否随 horizon 报告？ |
...
| **33 Bimanual / Dexterity / Tactile** | [Runnable Lab 14](../labs/runnable/lab14_tactile_reflex/README.md)；Lab 17 / [Runnable Lab 37](../labs/runnable/lab37_bimanual_coordination/README.md) | [Lab 14 CI Reference](../labs/runnable/lab14_tactile_reflex/REFERENCE_RESULTS.md)、[Lab 37 CI Reference](../labs/runnable/lab37_bimanual_coordination/REFERENCE_RESULTS.md)、ACT case、Hardware Atlas | 双臂共享物体中，endpoint convergence、object midpoint、relative pose/separation 与 internal load 是否被分开？显式 relative-coordinate feedback 是否因果降低 deformation/force？接触瞬态又应由慢语义策略还是快 tactile residual 处理？ |
...
| **36 Human–Robot / Multi-Robot** | [Runnable Lab 38](../labs/runnable/lab38_multi_robot_collaboration/README.md) | [Lab 38 CI Reference](../labs/runnable/lab38_multi_robot_collaboration/REFERENCE_RESULTS.md)、Failure Atlas communication/system 条目 | heterogeneous capability allocation 是否真实提高 throughput？heartbeat delay 是先拉长 makespan 还是直接降低 completion？dropout 与 shuffled capability metadata 会怎样？检测到单机器人故障后，interrupted work 是否真正 release/reallocate 并恢复？ |
