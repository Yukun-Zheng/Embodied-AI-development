...
- **[Runnable Labs](labs/runnable/README.md)** — 已进入永久 CI 的机制实验；当前覆盖 Active Perception、Tactile Reflex、Async Execution、Cross-Embodiment、Long-Horizon Memory、World Model MPC、Reasoning Negative Control、Continual Learning、Bimanual Coordination、Multi-Robot Collaboration、Safety Shield
...
其中 [`labs/runnable/`](labs/runnable/) 把选定 Lab 落成统一 executable contract。当前 11 个 reference labs 已进入永久 CI：
...
- **13** 个最小可执行脚本 + **11** 个 CI-verified runnable reference labs；
